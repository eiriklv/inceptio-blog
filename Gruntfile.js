...
var path = require('path'),
    ...
    configureGrunt = function(grunt) {
        ...
        //
        grunt.registerTask('test', 'Run tests and lint code', ['jshint', 'test-routes', 'test-unit', 'test-integration', 'test-functional']);
        ...
        grunt.registerTask('emberBuildDev', 'Build Ember JS & templates for development', ['clean:tmp', 'emberTemplates:dev', 'transpile', 'concat_sourcemap:dev']);

        // ### Ember Build *(Utility Task)*
        // All tasks related to building the Ember client code including transpiling ES6 modules and building templates
        grunt.registerTask('emberBuildProd', 'Build Ember JS & templates for production', ['clean:tmp', 'emberTemplates:prod', 'transpile', 'concat_sourcemap:prod']);
        ...
        grunt.registerTask('init', 'Prepare the project for development', ['shell:bower', 'shell:ghost_ui', 'update_submodules', 'default']);

        // ### Production assets
        // `grunt prod` - will build the minified assets used in production.
        //
        // It is otherwise the same as running `grunt`, but is only used when running Ghost in the `production` env.
        grunt.registerTask('prod', 'Build JS & templates for production', ['concat:prod', 'copy:prod', 'emberBuildProd', 'uglify:prod', 'master-warn']);
        ...
        grunt.registerTask('default', 'Build JS & templates for development', ['concat:dev', 'copy:dev', 'emberBuildDev']);
        ...
        grunt.registerTask('dev', 'Dev Mode; watch files and restart server on changes', ['concat:dev', 'copy:dev', 'emberBuildDev', 'express:dev', 'watch']);
